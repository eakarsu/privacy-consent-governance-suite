...
PORT="${PORT:-4720}"
DB_NAME="${PGDATABASE:-privacy_consent_governance_suite}"
DB_HOST="${PGHOST:-127.0.0.1}"

echo "======================================="
echo "      Privacy Consent Governance Suite"
echo "======================================="
echo
...
echo "Starting privacy consent governance suite frontend on http://localhost:$PORT"
echo "Login: admin@privacy-consent.local / admin123"
