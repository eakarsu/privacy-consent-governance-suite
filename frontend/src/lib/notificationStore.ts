...
const seed: NotificationItem[] = [
  { id: 'note-1', title: 'Consents alert', detail: 'Consents queue needs review.', read: false },
  { id: 'note-2', title: 'Data Subjects approval due', detail: 'Data Subjects exception list needs approval.', read: false },
