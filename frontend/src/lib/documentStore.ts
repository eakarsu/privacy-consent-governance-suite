...
const seed: DocumentRecord[] = [
  { id: 'doc-1', name: 'Consents Packet', type: 'Consents', owner: 'Governance Lead', status: 'In review', updatedAt: '2026-05-24 10:00' },
  { id: 'doc-2', name: 'Data Subjects Review Bundle', type: 'Data Subjects', owner: 'Operations Lead', status: 'Approval pending', updatedAt: '2026-05-24 11:20' },
