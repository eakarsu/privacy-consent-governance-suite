export const AUTH_COOKIE = 'privacy_consent_governance_suite_session';
...
export const demoUsers: DemoUser[] = [
  {
    email: 'admin@privacy-consent.local',
    password: 'admin123',
    firstName: 'Legal',
    lastName: 'Operator',
    role: 'admin',
  ...
  {
    email: 'manager@privacy-consent.local',
    password: 'manager123',
    firstName: 'Legal',
    lastName: 'Manager',
    role: 'manager',
  ...
  {
    email: 'analyst@privacy-consent.local',
    password: 'analyst123',
    firstName: 'Legal',
    lastName: 'Analyst',
    role: 'analyst',
