...
export default function DashboardPage() {
  return (
    <UnifiedShell
      ...
      title="Privacy Consent Governance Dashboard"
      subtitle="One merged privacy consent governance view for Consents, Data Subjects, Requests, Systems, Retention, documents, audit, and AI."
    >
      ...
      <div className="grid columns-2">
        <div className="card stack">
          ...
          <div className="muted">
            This suite removes project-based navigation and groups shared privacy consent governance jobs into one surface. Consents, Data Subjects, Requests, Systems, Retention, Policies, documents, audit, and AI are presented as platform features.</div>
